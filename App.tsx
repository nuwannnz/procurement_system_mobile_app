  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        ...
        />
        <Stack.Screen
          name={SCREENS.VIEW_ORDER}
          component={ViewOrderComponent}
        />
        <Stack.Screen
          name={SCREENS.DETAILS_ORDER}
          component={DetailedOrderComponent}
        />
        <Stack.Screen
          name={SCREENS.DRAFTS_ORDER}
          component={DraftsOrderComponent}
        />
        <Stack.Screen
          name={SCREENS.RETURN_ORDER}
          component={ReturnOrderComponent}
        />
        <Stack.Screen
          name={SCREENS.DELIVERED_ORDER}
          component={DeliveredOrderComponent}
        />
        <Stack.Screen name={SCREENS.SUPPLIER_HOME} component={HomePage} />
        <Stack.Screen
          name={SCREENS.INCOMING_ORDER}
          component={IncomingOrders}
        />
        <Stack.Screen
          name={SCREENS.SUPPLIER_ORDER_DETAILS}
          component={OrderDetails}
        />
        <Stack.Screen
          name={SCREENS.SUPPLIER_DELIVERED_ORDER}
          component={DeliveredOrders}
        />
        <Stack.Screen
          name={SCREENS.PAYMENTS_RECEIVED}
          component={PaymentReceived}
        />
        <Stack.Screen
          name={SCREENS.RETURN_REQUESTS}
          component={ReturnRequests}
        />
        <Stack.Screen
          name={SCREENS.RETURN_REQUESTS_DETAILS}
          component={ReturnRequestsDetails}
        />
        <Stack.Screen
