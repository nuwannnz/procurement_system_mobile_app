...
export default function ReturnRequestsDetails() {
    return (
       <ScrollView>
            <View style={styles.container}>
                <Text style={styles.title}>Return Goods Details</Text>
                ...
                <View style={{alignItems: "center"}}>
                    <TouchableOpacity style={[BTN_STYLE.ACCENT_DENGER_BUTTON, {width: 150, height: 45, marginTop: 20}]}>
                        <Text style={{color: COLORS.textOnAccentColor, fontWeight: "bold"}}>Issue Credit Note</Text>
                    </TouchableOpacity>
                </View>
